...
var questions = [
    ...
    {
      title: "Nine Inch Nails' first release, Pretty Hate Machine, came out in:",
      choices: ["1987", "1989", "1991", "1993"],
      answer: "1989"
    },
    {
      title: "Nine Inch Nails has been activ since:",
  ...
  function displayQuiz() {
        ...
        button4.addEventListener("click", displayQuizTwo);
         // event listener with two consequences: one goes to next q & add it to storage too idk lol
        };
        ...
        function displayResults() { 
          ...
          lower1.textContent = " ";
          lower2.textContent = "Your final score is: ";
          lower3.textContent = " ";
          lower4.textContent = " ";
          };
